#!/usr/bin/env node
/**
 * IndexNow ile Yandex + Bing'e sayfa/ilan güncellemelerini anında bildirir.
 ...
 * Anahtar doğrulama dosyası: /<key>.txt (IndexNow spesifikasyonu gereği
...
const HOST = "ibrahimyilmazgayrimenkul.com";
const KEY = "1d6836b689ca76b19bb939ed9a00dc76";
...
async function main() {
  ...
  if (urls.length === 0) {
    console.log("sitemap.xml'de URL bulunamadı, IndexNow gönderilmedi.");
    return;
  }
